...
function ProfileSideBar() {
  return (
    <>
    <div className='profileBarLarge'>
      <div className='flex flex-col justify-between bg-white min-h-screen w-96'>
        <div className='flex flex-col items-center gap-10'>
          <img className='pt-5' src="./burgerbinassets/burgerbinlogo.png"/>
